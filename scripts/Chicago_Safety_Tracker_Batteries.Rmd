...
The city averaged <h8>`r prettyNum(round(batteries_city$last12mos/52,0), big.mark=",")`</h8> batteries a week over the last 12 months. In 2019, that number was <h8>`r prettyNum(round(batteries_city$total19/52,0), big.mark=",")`</h8> a week. In Chicago, 
