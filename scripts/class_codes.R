...
classcodes <- chicago_crime %>%
  group_by(primary_type,description,fbi_code) %>%
  summarise(count=n())

# some mapping by Chicago PD definitions to codes, etc
# homicide is fbi code 1A
# robbery is primary_type "robbery"
