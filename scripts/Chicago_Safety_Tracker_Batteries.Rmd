...
The danger is not the same neighborhood to neighborhood. ABC7's data team looked at the Houston Police Department's data by neighborhood from 2019 through `r format(asofdate, "%B %d")`.
...
L.control.zoom({ position: 'topright' }).addTo(this)
  ...
  addLegend(opacity = 0.6,
            ...
            pal = batterypal1,
            position = "bottomleft", 
            title = paste(sep="","<popuptitle>Assault Rate<br><popupchatter>Assaults/100K people<br>Citywide: ",prettyNum(round(batteries_city$rate_last12,0), big.mark=",")),
            group = "Rate",
