...
Yearly average<br>2023 to 2025</p>
</div>
<div class="card" style="background-color:#99a0a5;">
...
Per 100,000 people<br>2023 to 2025</p>
</div>
</div>
<br>
...
<subhead>A closer look at Chicago vehicle thefts by neighborhood</subhead>

The risk is not the same neighborhood to neighborhood. ABC7's data team looked at the Chicago Police Department's data by neighborhood from 2019 through `r format(asofdate, "%B %d, %Y")`.
...
"</td>
				...
				<td>2022</td>
				<td>",
autothefts_area$total22,
"</td>
				<td>",
prettyNum(round(autothefts_area$rate22,0),big.mark =","),
"</td>
			</tr>
									<tr>
				<td>2023</td>
				<td>",
autothefts_area$total23,
"</td>
				<td>",
prettyNum(round(autothefts_area$rate23,0),big.mark =","),
"</td>
			</tr>
						<tr>
				<td>2024</td>
				<td>",
autothefts_area$total24,
"</td>
				<td>",
prettyNum(round(autothefts_area$rate24,0),big.mark =","),
"</td>
			</tr>
						<tr>
				<td>2025</td>
				<td>",
autothefts_area$total25,
"</td>
				<td>",
prettyNum(round(autothefts_area$rate25,0),big.mark =","),
"</td>
			</tr>
						<tr>
