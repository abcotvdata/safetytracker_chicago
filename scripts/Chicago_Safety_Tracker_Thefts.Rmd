...
<h2>ABC7 is tracking crime and safety across Chicago and in your neighborhood. 
...
<subhead>Chicago thefts neighborhood by neighborhood</subhead>
...
theftpal1 <- colorBin(c("#99a0a5",
                             ...
                             "#0058f6",
                             "#003ca6",
                             "#00215c"), thefts_area$rate_last12, bins = theftbins1,na.color = "#51585f")

theftpal2 <- colorBin(c("#99a0a5",
                             "#2787d6",
                             "#0058f6",
                             "#003ca6",
                             "#00215c"), thefts_area$last12mos, bins = theftbins2,na.color = "#51585f")

# Create quick labels for thefts map
theftlabel <- paste(sep="",
                     "<popuptitle>",
                     prettyNum(thefts_area$last12mos, big.mark=","),
                     " thefts </popuptitle><br>",
                     " in the last 12 months in <b>",
                     thefts_area$community_area,
                     "</b>, home to an estimated ",
                     prettyNum(thefts_area$population, big.mark=","),
                     " people.
<br>
<table>      
      <tr>
...
"</td>
				<td>",
prettyNum(round(thefts_area$rate19,0), big.mark=","),
"</td>
			</tr>
			<tr>
				<td>2020</td>
...
"</td>
				<td>",
prettyNum(round(thefts_area$rate20,0), big.mark=","),
"</td>
			</tr>
						<tr>
				<td>2021</td>
...
"</td>
				<td>",
prettyNum(round(thefts_area$rate21,0), big.mark=","),
"</td>
			</tr>
						<tr>
				<td>Last 12 months</td>
				<td>",
thefts_area$last12mos,
"</td>
				<td>",
prettyNum(round(thefts_area$rate_last12,0), big.mark=","),
"</td>
			</tr>
						<tr>
				<td>3-year Average</td>
				<td>",
round(thefts_area$avg_prior3years,0),
"</td>
				<td>",
prettyNum(round(thefts_area$rate_prior3years,0), big.mark=","),
"</td>
			</tr>
</table>")

# Creating police beats map for types of crimes
chicago_theft_map <- leaflet(thefts_area, options = leafletOptions(zoomControl = FALSE, zoomSnap = 0.5, zoomDelta=0.5)) %>%
...
L.control.zoom({ position: 'topright' }).addTo(this)
  ...
  addLegend(opacity = 0.6,
            values = thefts_area$rate_last12, 
            pal = theftpal1,
            position = "bottomleft", 
...
<iframe title="Thefts over $500 month by month since 2019" aria-label="Column Chart" id="datawrapper-chart-1CEWx" src="https://datawrapper.dwcdn.net/1CEWx/2/" scrolling="no" frameborder="0" style="width: 0; min-width: 100% !important; border: none;" height="400" data-external="1"></iframe><script type="text/javascript">!function(){"use strict";window.addEventListener("message",(function(e){if(void 0!==e.data["datawrapper-height"]){var t=document.querySelectorAll("iframe");for(var a in e.data["datawrapper-height"])for(var r=0;r<t.length;r++){if(t[r].contentWindow===e.source)t[r].style.height=e.data["datawrapper-height"][a]+"px"}}}))}();
</script>
  <br>
<br>
