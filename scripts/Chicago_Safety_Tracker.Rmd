...
ABC7's data team looked at the Chicago Police Department's crime incident data by community area from 2019 through `r format(asofdate, "%B %d")`. Totals here include murders, but not involuntary manslaughter or justifiable homicide.
