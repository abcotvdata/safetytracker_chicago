...
The danger is not the same neighborhood to neighborhood. ABC13's data team looked at the Chicago Police Department's public data about sexual assault reports by neighborhood from 2019 through `r format(asofdate, "%B %d")`.
...
houston_sexassault_map <- leaflet(sexassaults_area, options = leafletOptions(zoomControl = FALSE, zoomSnap = 0.5, zoomDelta=0.5)) %>%
...
<iframe title="Sexual assaults month by month, 2019 through last month" aria-label="Column Chart" id="datawrapper-chart-Ao9qp" src="https://datawrapper.dwcdn.net/Ao9qp/2/" scrolling="no" frameborder="0" style="width: 0; min-width: 100% !important; border: none;" height="400" data-external="1"></iframe><script type="text/javascript">!function(){"use strict";window.addEventListener("message",(function(e){if(void 0!==e.data["datawrapper-height"]){var t=document.querySelectorAll("iframe");for(var a in e.data["datawrapper-height"])for(var r=0;r<t.length;r++){if(t[r].contentWindow===e.source)t[r].style.height=e.data["datawrapper-height"][a]+"px"}}}))}();
  ...
  <br>
<br>
<!-- <subhead>Risk of sexual assault in chicago vs. other causes of death in Texas</subhead> -->
