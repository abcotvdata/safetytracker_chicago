...
<br>
Homicides over the last 12 months are trending <h8>`r ifelse(murders_city$inc_25tolast12>=0," up"," down")` `r ifelse(murders_city$inc_25tolast12>=0,murders_city$inc_25tolast12,substring(murders_city$inc_25tolast12,2))`%</h8> compared to 2025, according to Chicago Police Department data through `r format(asofdate, "%B %d")`.
...
One way to think about the danger: four years ago, the murder rate was <h8>`r murders_city$rate19`</h8> per 100,000 residents. 
...
<br>
<br>
<!-- <subhead>Risk of being murdered in Chicago vs. other causes of death in Cook County</subhead> -->
