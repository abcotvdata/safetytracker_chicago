...
![<popupchatter>Updated `r format(Sys.time(), '%B %d, %Y')` by the ABC7 Data Team</popupchatter>](https://github.com/abcotvdata/safetytracker_chicago/raw/main/docs/banner_placeholder.png)
...
<h2>ABC7 is tracking crime and safety across Chicago and in your neighborhood. <br>You can choose which crime to examine: <select onchange="window.location=this.value">
<option value="https://abcotvdata.github.io/safetytracker_chicago/Chicago_Safety_Tracker_AutoThefts.html">Auto Thefts</option>
<option value="https://abcotvdata.github.io/safetytracker_chicago/Chicago_Safety_Tracker_Assaults.html">Assaults</option>
<option value="https://abcotvdata.github.io/safetytracker_chicago/Chicago_Safety_Tracker_Burglaries.html">Burglaries</option>
<option value="https://abcotvdata.github.io/safetytracker_chicago/Chicago_Safety_Tracker_DrugCrimes.html">Drug Crimes</option>
...
<subhead>A closer look at Chicago auto thefts by neighborhood</subhead>

The risk is not the same neighborhood to neighborhood. ABC7's data team looked at the Chicago Police Department's data by neighborhood from 2019 through `r format(asofdate, "%B %d")`.
...
autotheftpal1 <- colorBin(c("#99a0a5",
                             ...
                             "#0058f6",
                             "#003ca6",
                             "#00215c"), autothefts_area$rate_last12, bins = autotheftbins1,na.color = "#51585f")

autotheftpal2 <- colorBin(c("#99a0a5",
                             "#2787d6",
                             "#0058f6",
                             "#003ca6",
                             "#00215c"), autothefts_area$last12mos, bins = autotheftbins2,na.color = "#51585f")

# Create quick labels for autothefts map
autotheftlabel <- paste(sep="",
                     "<popuptitle>",
                     autothefts_area$last12mos,
                     " auto thefts </popuptitle><br>",
                     " in the last 12 months in <b>",
                     autothefts_area$community_area,
                     "</b>, home to an estimated ",
                     prettyNum(autothefts_area$population, big.mark=","),
                     " people.
<br>
<table>      
      <tr>
			...
			<tr>
				<td>2019</td>
				<td>",
autothefts_area$total19,
"</td>
				<td>",
prettyNum(round(autothefts_area$rate19,0),big.mark =","),
"</td>
			</tr>
			<tr>
				<td>2020</td>
				<td>",
autothefts_area$total20,
"</td>
				<td>",
prettyNum(round(autothefts_area$rate20,0),big.mark =","),
"</td>
			</tr>
						<tr>
				<td>2021</td>
				<td>",
autothefts_area$total21,
"</td>
				<td>",
prettyNum(round(autothefts_area$rate21,0),big.mark =","),
"</td>
			</tr>
						<tr>
...
"</td>
				<td>",
prettyNum(round(autothefts_area$rate_last12,0),big.mark =","),
"</td>
			</tr>
						<tr>
				<td>3-year Average</td>
				<td>",
round(autothefts_area$avg_prior3years,0),
"</td>
				<td>",
prettyNum(round(autothefts_area$rate_prior3years,0),big.mark =","),
"</td>
			</tr>
</table>")

# Creating police beats map for types of crimes
chicago_autotheft_map <- leaflet(autothefts_area, options = leafletOptions(zoomControl = FALSE, zoomSnap = 0.5, zoomDelta=0.5)) %>%
...
L.control.zoom({ position: 'topright' }).addTo(this)
  ...
  addLegend(opacity = 0.6,
            values = autothefts_area$rate_last12, 
            pal = autotheftpal1,
            position = "bottomleft", 
  ...
  addLegend(opacity = 0.6,
            values = autothefts_area$last12mos, 
            pal = autotheftpal2,
            position = "bottomleft", 
...
chicago_autotheft_map
```
<br>
<br>
<!-- <subhead>Auto thefts month by month, 2019 through last month</subhead> -->

<iframe title="Vehicle thefts month by month since 2019" aria-label="Column Chart" id="datawrapper-chart-OaGTy" src="https://datawrapper.dwcdn.net/OaGTy/1/" scrolling="no" frameborder="0" style="width: 0; min-width: 100% !important; border: none;" height="400" data-external="1"></iframe><script type="text/javascript">!function(){"use strict";window.addEventListener("message",(function(e){if(void 0!==e.data["datawrapper-height"]){var t=document.querySelectorAll("iframe");for(var a in e.data["datawrapper-height"])for(var r=0;r<t.length;r++){if(t[r].contentWindow===e.source)t[r].style.height=e.data["datawrapper-height"][a]+"px"}}}))}();
</script>
  <br>
<br>
<!-- <subhead>Risk of property crime in major cities</subhead> -->

<iframe title="2021 property crime rate comparison in select major cities" aria-label="Bar Chart" id="datawrapper-chart-HuElR" src="https://datawrapper.dwcdn.net/HuElR/1/" scrolling="no" frameborder="0" style="width: 0; min-width: 100% !important; border: none;" height="436" data-external="1"></iframe><script type="text/javascript">!function(){"use strict";window.addEventListener("message",(function(e){if(void 0!==e.data["datawrapper-height"]){var t=document.querySelectorAll("iframe");for(var a in e.data["datawrapper-height"])for(var r=0;r<t.length;r++){if(t[r].contentWindow===e.source)t[r].style.height=e.data["datawrapper-height"][a]+"px"}}}))}();
</script>