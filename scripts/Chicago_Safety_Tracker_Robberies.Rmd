...
<subhead>A closer look at Chicago robberies neighborhood by neighborhood</subhead>
...
robberypal1 <- colorBin(c("#99a0a5",
                             ...
                             "#0058f6",
                             "#003ca6",
                             "#00215c"), robberies_area$rate_last12, bins = robberybins1,na.color = "#51585f")

robberypal2 <- colorBin(c("#99a0a5",
                             "#2787d6",
                             "#0058f6",
                             "#003ca6",
                             "#00215c"), robberies_area$last12mos, bins = robberybins2,na.color = "#51585f")


# Create quick labels for robberies map
robberylabel <- paste(sep="",
                     "<popuptitle>",
                     robberies_area$last12mos,
                     " robberies </popuptitle><br>",
                     " in the last 12 months in <b>",
                     robberies_area$community_area,
                     "</b>, home to an estimated ",
                     prettyNum(robberies_area$population, big.mark=","),
                     " people.
<br>
<table>      
      <tr>
			...
			<tr>
				<td>2019</td>
				<td>",
robberies_area$total19,
"</td>
				<td>",
round(robberies_area$rate19,0),
"</td>
			</tr>
			<tr>
				<td>2020</td>
				<td>",
robberies_area$total20,
"</td>
				<td>",
round(robberies_area$rate20,0),
"</td>
			</tr>
						<tr>
				<td>2021</td>
				<td>",
robberies_area$total21,
"</td>
				<td>",
round(robberies_area$rate21,0),
"</td>
			</tr>
						<tr>
...
"</td>
				<td>",
round(robberies_area$rate_last12,0),
"</td>
			</tr>
						<tr>
				<td>3-year Average</td>
				<td>",
round(robberies_area$avg_prior3years,0),
"</td>
				<td>",
round(robberies_area$rate_prior3years,0),
"</td>
			</tr>
</table>")

# Creating police beats map for types of crimes
chicago_robbery_map <- leaflet(robberies_area, options = leafletOptions(zoomControl = FALSE, zoomSnap = 0.5, zoomDelta=0.5)) %>%
...
L.control.zoom({ position: 'topright' }).addTo(this)
  ...
  addLegend(opacity = 0.6,
            values = robberies_area$rate_last12, 
            pal = robberypal1,
            position = "bottomleft", 
  ...
  addLegend(opacity = 0.6,
            values = robberies_area$last12mos, 
            pal = robberypal2,
            position = "bottomleft", 
...
<iframe title="Robberies month by month since 2019" aria-label="Column Chart" id="datawrapper-chart-NntXP" src="https://datawrapper.dwcdn.net/NntXP/1/" scrolling="no" frameborder="0" style="width: 0; min-width: 100% !important; border: none;" height="400" data-external="1"></iframe><script type="text/javascript">!function(){"use strict";window.addEventListener("message",(function(e){if(void 0!==e.data["datawrapper-height"]){var t=document.querySelectorAll("iframe");for(var a in e.data["datawrapper-height"])for(var r=0;r<t.length;r++){if(t[r].contentWindow===e.source)t[r].style.height=e.data["datawrapper-height"][a]+"px"}}}))}();
</script>
  <br>
<br>
