...
<subhead>A closer look at Chicago burglaries neighborhood by neighborhood</subhead>
...
burglarypal1 <- colorBin(c("#99a0a5",
                             ...
                             "#0058f6",
                             "#003ca6",
                             "#00215c"), burglaries_area$rate_last12, bins = burglarybins1,na.color = "#51585f")

burglarypal2 <- colorBin(c("#99a0a5",
                             "#2787d6",
                             "#0058f6",
                             "#003ca6",
                             "#00215c"), burglaries_area$last12mos, bins = burglarybins2,na.color = "#51585f")


# Create quick labels for burglaries map
burglarylabel <- paste(sep="",
                     "<popuptitle>",
                     burglaries_area$last12mos,
                     " burglaries </popuptitle><br>",
                     " in the last 12 months in <b>",
                     burglaries_area$community_area,
                     "</b>, home to an estimated ",
                     prettyNum(burglaries_area$population, big.mark=","),
                     " people.
<br>
<table>      
      <tr>
			...
			<tr>
				<td>2019</td>
				<td>",
burglaries_area$total19,
"</td>
				<td>",
round(burglaries_area$rate19,0),
"</td>
			</tr>
			<tr>
				<td>2020</td>
				<td>",
burglaries_area$total20,
"</td>
				<td>",
round(burglaries_area$rate20,0),
"</td>
			</tr>
						<tr>
				<td>2021</td>
				<td>",
burglaries_area$total21,
"</td>
				<td>",
round(burglaries_area$rate21,0),
"</td>
			</tr>
						<tr>
...
"</td>
				<td>",
round(burglaries_area$rate_last12,0),
"</td>
			</tr>
						<tr>
				<td>3-year Average</td>
				<td>",
round(burglaries_area$avg_prior3years,0),
"</td>
				<td>",
round(burglaries_area$rate_prior3years,0),
"</td>
			</tr>
</table>")

# Creating police beats map for types of crimes
chicago_burglary_map <- leaflet(burglaries_area, options = leafletOptions(zoomControl = FALSE, zoomSnap = 0.5, zoomDelta=0.5)) %>%
...
L.control.zoom({ position: 'topright' }).addTo(this)
  ...
  addLegend(opacity = 0.6,
            values = burglaries_area$rate_last12, 
            pal = burglarypal1,
            position = "bottomleft", 
  ...
  addLegend(opacity = 0.6,
            values = burglaries_area$last12mos, 
            pal = burglarypal2,
            position = "bottomleft", 
...
chicago_burglary_map
```
<br>
<br>
<!-- <subhead>Burglaries month by month, 2019 through last month</subhead> -->

<iframe title="Burglaries month by month since 2019" aria-label="Column Chart" id="datawrapper-chart-er0c2" src="https://datawrapper.dwcdn.net/er0c2/2/" scrolling="no" frameborder="0" style="width: 0; min-width: 100% !important; border: none;" height="400" data-external="1"></iframe><script type="text/javascript">!function(){"use strict";window.addEventListener("message",(function(e){if(void 0!==e.data["datawrapper-height"]){var t=document.querySelectorAll("iframe");for(var a in e.data["datawrapper-height"])for(var r=0;r<t.length;r++){if(t[r].contentWindow===e.source)t[r].style.height=e.data["datawrapper-height"][a]+"px"}}}))}();
</script>
  <br>
<br>
