...
<option value="https://abcotvdata.github.io/safetytracker_chicago/Chicago_Safety_Tracker_Assaults.html">Batteries</option>
...
One way to think about the danger: three years ago, the murder rate was <h8>`r murders_city$rate19`</h8> per 100,000 residents. That's slightly less than risk as dying in a vehicle crash in Illinois.

During the pandemic, a person's chance of being murdered in CHicago rose above the likelihood of dying in a vehicle crash. 
<br>
<br>
...
ABC13's data team looked at the Chicago Police Department's data by neighborhood from 2019 through `r format(asofdate, "%B %d")`.
